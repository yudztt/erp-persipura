    ...
    <div class="db-kpis">
        <article class="db-stat">
            ...
            <div class="db-stat__body">
                ...
                <span class="db-stat__value">{{ $totalSku ?? '1.284' }}</span>
                <span class="db-stat__hint db-stat__hint--up">+42 bulan ini</span>
            </div>
        </article>
        ...
        <article class="db-stat">
            ...
            <div class="db-stat__body">
                ...
                <span class="db-stat__value">Rp {{ $penjualanBulanIni ?? '842M' }}</span>
                <span class="db-stat__hint db-stat__hint--up">+18,4%</span>
            </div>
        </article>
        ...
        <article class="db-stat">
            ...
            <div class="db-stat__body">
                ...
                <span class="db-stat__value">{{ $stokRendahCount ?? '23' }}</span>
        ...
        <article class="db-stat">
            ...
            <div class="db-stat__body">
                <span class="db-stat__label">Kapasitas Gudang</span>
                <span class="db-stat__value">{{ $kapasitasGudang ?? '73%' }}</span>
                <div class="db-stat__bar"><i style="width: {{ $kapasitasGudang ?? '73%' }}"></i></div>
            </div>
        </article>
    </div>
                ...
                <div class="db-chart-wrap">
                    <div class="db-chart" role="img" aria-label="Grafik tren penjualan Des–Mei 2026">
                        <svg viewBox="0 0 400 130" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <text x="38" y="24" text-anchor="end" class="db-chart__axis">1B</text>
                            <text x="38" y="44" text-anchor="end" class="db-chart__axis">800M</text>
                            <text x="38" y="64" text-anchor="end" class="db-chart__axis">600M</text>
                            <text x="38" y="84" text-anchor="end" class="db-chart__axis">400M</text>
                            <text x="38" y="104" text-anchor="end" class="db-chart__axis">200M</text>
                            
                            <path d="M55,90 L121,76 L187,64 L253,48 L319,56 L385,32 L385,100 L55,100 Z" fill="url(#dbG)"/>
                            <polyline points="55,90 121,76 187,64 253,48 319,56 385,32" fill="none" stroke="#C1121F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            
                            @foreach([[55,90],[121,76],[187,64],[253,48],[319,56],[385,32]] as [$cx,$cy])
                            <circle cx="{{ $cx }}" cy="{{ $cy }}" r="{{ $cx==385?4:3 }}" fill="#C1121F" @if($cx==385) stroke="#fff" stroke-width="2" @endif/>
                            @endforeach
                            
                            @foreach(['Des'=>55,'Jan'=>121,'Feb'=>187,'Mar'=>253,'Apr'=>319,'Mei'=>385] as $l => $x)
                            <text x="{{ $x }}" y="120" text-anchor="middle" class="db-chart__axis">{{ $l }}</text>
                            @endforeach
                        </svg>
                    </div>
                    <ul class="db-chart-legend">
                        <li><span class="db-chart-legend__dot"></span> Penjualan</li>
                        <li class="db-chart-legend__hi"><strong>Mei</strong> tertinggi</li>
                    </ul>
                </div>
            </section>
        </div>
        ...
        <div class="db-stack">
            ...
            <section class="db-card db-card--forecast">
                <header class="db-forecast__head">
                    ...
                    <h2 class="db-forecast__title">Juni 2026</h2>
                </header>
                <ul class="db-forecast__list">
                    <li><span>Pendapatan</span><strong>Rp 1,1 M <em>+30,6%</em></strong></li>
                    <li><span>Top produk</span><strong>Jersey Kandang</strong></li>
                    <li><span>Restock</span><strong class="warn">8 SKU kritis</strong></li>
                </ul>
        ...
        <section class="db-card db-card--table">
            ...
            <div class="db-table-wrap">
                <table class="db-table">
                    ...
                    <tbody>
                        <tr><td>Jersey Kandang Sz L</td><td class="qty qty--c">8</td><td><span class="db-badge db-badge--danger">Kritis</span></td></tr>
                        <tr><td>Scarf Persipura 2026</td><td class="qty qty--w">15</td><td><span class="db-badge db-badge--warn">Rendah</span></td></tr>
                        <tr><td>Jersey Away Sz M</td><td class="qty qty--w">12</td><td><span class="db-badge db-badge--warn">Rendah</span></td></tr>
                        <tr><td>Kaos Polo Persipura</td><td class="qty qty--c">5</td><td><span class="db-badge db-badge--danger">Kritis</span></td></tr>
                    </tbody>
                </table>
            </div>
        </section>
        ...
        <section class="db-card db-card--table">
            ...
            <div class="db-table-wrap">
                <table class="db-table">
                    ...
                    <tbody>
                        <tr><td class="code">#SO-089</td><td><span class="db-badge db-badge--danger">Keluar</span></td><td>50</td><td class="muted">31 Mei</td></tr>
                        <tr><td class="code">#SI-088</td><td><span class="db-badge db-badge--success">Masuk</span></td><td>200</td><td class="muted">30 Mei</td></tr>
                        <tr><td class="code">#SO-087</td><td><span class="db-badge db-badge--danger">Keluar</span></td><td>30</td><td class="muted">29 Mei</td></tr>
                        <tr><td class="code">#SI-086</td><td><span class="db-badge db-badge--success">Masuk</span></td><td>150</td><td class="muted">28 Mei</td></tr>
                    </tbody>
                </table>
            </div>
        </section>
